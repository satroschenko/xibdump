...
class XibFileParser: NSObject {
    ...
    func parse(url: URL) throws -> XibFile {
        ...
        xibFile.xibKeys = try readKeys(offset: xibFile.keyFileOffset, count: xibFile.keyCount, dataStream: dataStream)
        xibFile.xibClasses = try readClasses(offset: xibFile.classNameFileOffset, count: xibFile.classNameCount, dataStream: dataStream)
        xibFile.xibObjects = try readObjects(offset: xibFile.objectFileOffset, count: xibFile.objectCount, dataStream: dataStream, classes: xibFile.xibClasses)
        xibFile.xibParameters = try readParameters(offset: xibFile.parametersFileOffset, count: xibFile.parametersCount, dataStream: dataStream, keys: xibFile.xibKeys)
